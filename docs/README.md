...
| [localization.md](localization.md) | Where user-facing text lives, how the tables are keyed and verified, and what stays English on purpose | user-facing text, a language, or a table changes |
